...
public class ScheduleableModule {
    @Provides
    IScheduleableInteractor providesScheduleableInteractor(ISummitEventDataStore summitEventDataStore, ISummitAttendeeDataStore summitAttendeeDataStore, IDTOAssembler dtoAssembler, ISecurityManager securityManager) {
        return new ScheduleableInteractor(summitEventDataStore, summitAttendeeDataStore, dtoAssembler, securityManager);
    }
