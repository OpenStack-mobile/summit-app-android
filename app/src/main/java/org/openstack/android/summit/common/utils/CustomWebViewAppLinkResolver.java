...
/**
 * Created by smarcet on 3/27/18.
 */

public class CustomWebViewAppLinkResolver implements AppLinkResolver {
     ...
     */
    public CustomWebViewAppLinkResolver(Context context) {
    ...
    public Task<AppLink> getAppLinkFromUrlInBackground(final Uri url) {
        ...
        return Task.callInBackground(new Callable<java.lang.Void>() {
            @Override
        ...
        }).onSuccessTask(new Continuation<java.lang.Void, Task<JSONArray>>() {
            @Override
            public Task<JSONArray> then(Task<java.lang.Void> task) throws Exception {
