...
public class EventDetailInteractor extends ScheduleableInteractor implements IEventDetailInteractor {
    ...
    @Inject
    public EventDetailInteractor(ISummitEventDataStore summitEventDataStore, ISummitAttendeeDataStore summitAttendeeDataStore, IReachability reachability, IDTOAssembler dtoAssembler, ISecurityManager securityManager) {
