...
public class MemberProfileInteractor extends BaseInteractor implements IMemberProfileInteractor {
    ...
    public MemberProfileInteractor(ISpeakerDataStore presentationSpeakerDataStore, ISecurityManager securityManager, IDTOAssembler dtoAssembler, ISummitDataStore summitDataStore, ISummitSelector summitSelector, IReachability reachability) {
