...
public class MemberProfileModule {
    ...
    @Provides
    IMemberProfileInteractor providesMemberProfileInteractor(IGenericDataStore genericDataStore, ISecurityManager securityManager, IDTOAssembler dtoAssembler) {
        return new MemberProfileInteractor(genericDataStore, securityManager, dtoAssembler);
    }
