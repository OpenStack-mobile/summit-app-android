...
public class LevelListModule {
    ...
    @Provides
    ILevelListInteractor providesLevelListInteractor(ISummitEventDataStore summitEventDataStore, IDTOAssembler dtoAssembler, IDataUpdatePoller dataUpdatePoller) {
        return new LevelListInteractor(summitEventDataStore, dtoAssembler, dataUpdatePoller);
    }
