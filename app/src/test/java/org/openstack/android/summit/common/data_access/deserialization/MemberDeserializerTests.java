...
public class MemberDeserializerTests {
    ...
    public void deserialize_validJSONForMemberWithRolesAttendeeAndSpeaker_returnsCorrectInstance() throws JSONException {
        ...
        SpeakerDeserializer presentationSpeakerDeserializer = mock(SpeakerDeserializer.class);
        when(presentationSpeakerDeserializer.deserialize(eq(speakerJsonString))).thenReturn(speaker);
        ...
        Assert.assertEquals(speaker, member.getSpeakerRole());
    }
